  ...
  return (
    <div className='p-6 bg-white rounded-lg md:w-[33%] w-full'>
        <div className='flex justify-between'>
            <h3 className='font-bold text-[16px] leading-[18px] md:text-[22px] md:leading-[26px] text-[#2F438F]'>{treatment.name}</h3>
        ...
        <div className='text-[12px] leading-[18px] md:text-[15px] md:leading-[22px] mt-4'>
            ...
            <ul>
                {
                    treatment.benefits.map(benefit => <li><span className='font-extrabold ml-0 md:ml-2'>•</span> {benefit}</li>)
                }
            </ul>
        </div>
    </div>
